...
async function exampleUsage(whaleWalletAddress) {
    try {
...
const getWhaleAddressTransaction = async (whaleWalletAddress) => {
    const finallyResult = await exampleUsage(whaleWalletAddress);
    return finallyResult;
}

module.exports = getWhaleAddressTransaction; // Export the function for use in other modules